...
def get_data_strings(lc=True):
    if lc:
        return pd.read_table('../data/preprocessed_lc.tsv')
    else:
        return pd.read_table('../data/preprocessed.tsv')


def get_data_indexes(lc=True):
    if lc:
        return pd.read_table('../data/preprocessed_index_lc.tsv')
    else:
        return pd.read_table('../data/preprocessed_index.tsv')
